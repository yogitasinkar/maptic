                        ...
                        <div className='d-flex justify-content-between'>
                            ...
                            <div>
                                ...
                                <ButtonGroup className='m-2'>
                                    <Button color={recycleView ? 'muted' : 'primary'} onClick={() => setRecycleView(!recycleView)}  >Projects</Button>
                                    <Button color={recycleView ? 'primary' : 'muted'} onClick={() => setRecycleView(!recycleView)}  >NGOs</Button>
                                </ButtonGroup>
                            </div>
                        </div>
                    </div>
